...
class TestIntegerTypes < Minitest::Test
  ...
  def test_integer_type_creation
    ...
    tiny = 42.to_tinyint
    small = 1000.to_smallint
    int = 50000.to_int
    big = 9223372036854775807.to_bigint
    var = 123456789012345678901234567890.to_varint
  ...
  def test_integer_overflow_handling
    ...
    tiny_overflow = 128.to_tinyint  # Should wrap to -128
    assert_equal(-128, tiny_overflow.to_i)

    small_overflow = 32768.to_smallint  # Should wrap to -32768
    assert_equal(-32768, small_overflow.to_i)

    int_overflow = 2147483648.to_int  # Should wrap to -2147483648
  ...
  def test_prepared_statement_with_typed_integers
    ...
    statement = prepared.bind([1.to_int, tiny, small, int, big, var])
